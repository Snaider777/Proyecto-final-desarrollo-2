...
public class MuebleDto {
    ...
    public String getDescripcionMueble() {return descripcionMueble;}
    public void setDescripcionMueble(String descripcionMueble) {this.descripcionMueble = descripcionMueble;}
